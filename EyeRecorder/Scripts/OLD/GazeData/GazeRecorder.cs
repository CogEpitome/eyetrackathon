...
namespace HMDEyeTracking {
    ...
    public class GazeRecorder : MonoBehaviour
    {
        ...
        private bool enable;
        //The name of the current file (constant file name plus version number)
        ...
        private void OpenDataFile()
        {
            ...
            fileName = DATA_FILE_NAME + DATA_FILE_TYPE;
            int v = 0;
            while(File.Exists(Path.Combine(DATA_FILE_DIRECTORY, fileName))){
                fileName = DATA_FILE_NAME + "(" + v + ")"+DATA_FILE_TYPE;
                v++;
            }
